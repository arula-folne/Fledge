...
今後、運用中の **webw** と連携し、アプリ内で使える**着せ替え機能**を提供する予定です。  
この連携にあわせて、Fledge 独自のアカウント機能を導入し、利用率の把握やサービス改善に必要な範囲で利用状況の解析を行う可能性があります。

ただし、その場合でも次の方針は維持します。

- 個人情報は保護し、取り扱い範囲を明示する
- 認証情報や個人情報をソースコードへ含めない
- 公開リポジトリには秘密情報や実データを含めない
- 実装前後でポリシーが変わる場合は、GitHub 上の文書を更新して公開する
